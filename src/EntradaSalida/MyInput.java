...
// Lee un dato tipo int  desde el teclado
	...
	public static int readInt() {
		try {
			...
			System.out.println("El dato introducido no tiene formato de número entero. Inténtelo de nuevo.");
			readInt();
		}
		return Integer.parseInt(readString());
	}
...
//Lee un dato tipo float desde el teclado
	 ...
	 *                      si el fichero est� en el raiz del proyecto, este String
	 *                      coincide con el nombre del fichero con su extensi�n.
	 * @return Un ArrayList de String con todas las palabras contenidas en el
	 *         fichero de texto.
	 */
